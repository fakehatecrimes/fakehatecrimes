Fakehatecrimes::Application.routes.draw do
  ...
  get  'search' =>     'media#search' # This has to come before resources, or it thinks 'search' is a medium id
  post 'search' =>     'media#search'

  resources :fakes, :media, :users, :user_sessions, :password_resets, :emailers
